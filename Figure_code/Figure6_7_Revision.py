...
korea.loc[korea['SIG_CD'] == '47280', '2022PS_cluster'] = 2


korea.loc[korea['SIG_CD'] == '47280', '2022NB_cluster'] = 2
# korea.loc[korea['SIG_CD'] == '47770', '2022NB_cluster'] = 1
korea.loc[korea['SIG_CD'] == '47280', '2022NB_cluster'] = 1

korea.loc[korea['SIG_CD'] == '47250', '2022ZF_cluster'] = 2
korea.loc[korea['SIG_CD'] == '47280', '2022ZF_cluster'] = 2
korea.loc[korea['SIG_CD'] == '43130', '2022ZF_cluster'] = 1
korea.loc[korea['SIG_CD'] == '47920', '2022ZF_cluster'] = 1
...
korea.loc[korea['SIG_CD'] == '47930', 'PS_cluster'] = 2
korea.loc[korea['SIG_CD'] == '42130', 'PS_cluster'] = 1
korea.loc[korea['SIG_CD'] == '43130', 'PS_cluster'] = 1


korea.loc[korea['SIG_CD'] == '47930', 'NB_cluster'] = 2 ## 225
korea.loc[korea['SIG_CD'] == '47770', 'NB_cluster'] = 1
korea.loc[korea['SIG_CD'] == '42780', 'NB_cluster'] = 1
korea.loc[korea['SIG_CD'] == '42790', 'NB_cluster'] = 1

korea.loc[korea['SIG_CD'] == '43150', 'ZF_cluster'] = 2
korea.loc[korea['SIG_CD'] == '43800', 'ZF_cluster'] = 2
korea.loc[korea['SIG_CD'] == '42230', 'ZF_cluster'] = 1
korea.loc[korea['SIG_CD'] == '47930', 'ZF_cluster'] = 1
...
plt.tight_layout()
plt.savefig(figure_path + 'Figure6_v2.tif', dpi = set_dpi, bbox_inches = 'tight')
plt.show()
...
plt.tight_layout()
plt.savefig(figure_path + 'Figure7_v2.tif', dpi = set_dpi, bbox_inches = 'tight')
plt.show()